...
int main()
{
    ...
    cout << "This system minimizes the number of transactions among multiple banks that use different modes of payment.There is one Central bank (with all payment modes) to act as an intermediary between banks that have no common mode of payment. \n\n";
